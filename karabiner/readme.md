...
- o + y - alfred youtube
- o + i - alfred iterm sessions
- o + a - alfred google search
- o + s - alfred duckduckgo
- o + d - alfred pdf search
- o + f - alfred 
- o + g - alfred github search
- o + h - alfred intellij search
- o + j - alfred mindnode search
- o + k - alfred folder search
- o + : - wiki search
- o + z - alfred spotify search
- o + x - alfred xcode search
- o + c - alfred km search
- o + v - alfred menu bar search
- o + b - alfred pocket search
- o + n - alfred bookmark folders search
- o + m - alfred maps search
- o + left shift - cmd + tab reverse
- o + tab - cmd + tab
- o + caps lock - dropzone
- o + space - dash search

##sticky p - more alfred
- p + a - alfred workflows search
- p + left shift - alfred choose port
...
- s + e - tab
- s + r - reverse tab
- s + i - paste app clipboard manager
- s + u - search in dash
- s + o - vim new line
- s + p - create typinator snippet from selection
...
- s + : - enter common text snippet (- ) or (// )
- s + z - undo
- s + c - ⌘ + ⌦
...
- s + m - end of line
- s + . - cut current line
- s + / - lowercase entire text
- s + t - lowercase selected text
- s + left shift - search google from selection
...
- d + o - zoom in (⌘ +)
- d + i - zoom out (⌘ -)
- d + p - highlight location of pointer
- d + f (held) - quickly move pointer
- d + left shift - google selected text
...
- g + u - reset bitbar status
- g + k - quick runnable action for testing
- g + l - show current bitbar task
- g + n - show notification pane
- g + m - show bartender menu bar
- g + p - reload karabiner config
- g + w - add new note
- g + j - create new bitbar task
...
- b + o - move to right desktop
- b + p - move top right corner
- b + n - alfred window manager
...
##sticky space
- a - skip focus break twice
- w - 1password quick search
- e - day one quick entry
- r - add link to pocket
- caps lock - open unclutter
- i - create new toggl activity
- o - start / pause focus session
- p - eggtimer alfred for new timed activity
- j - put link from active safari tab to clipboard
- k - new 2do quick task
- l - new 2do quick task with clipboard as note
- m - new fantastical quick add event
- n - archive a link with tags
