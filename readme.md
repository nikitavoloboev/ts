...
> Using [screenfetch](https://github.com/KittyKatt/screenFetch). I don't split my editors like that, usually use each window maximized, often with iPad as Sidecar for web/app dev.
